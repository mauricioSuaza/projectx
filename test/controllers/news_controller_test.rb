...
class NewsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create news" do
    assert_difference('New.count') do
      post news_url, params: { news: { content: @news.content, invoice: @news.invoice, title: @news.title } }
    end
  ...
  test "should update news" do
    patch news_url(@news), params: { news: { content: @news.content, invoice: @news.invoice, title: @news.title } }
