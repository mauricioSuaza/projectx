...
class ContactMessagesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create contact_message" do
    assert_difference('ContactMessage.count') do
      post contact_messages_url, params: { contact_message: { content: @contact_message.content, email: @contact_message.email, name: @contact_message.name } }
    end
  ...
  test "should update contact_message" do
    patch contact_message_url(@contact_message), params: { contact_message: { content: @contact_message.content, email: @contact_message.email, name: @contact_message.name } }
